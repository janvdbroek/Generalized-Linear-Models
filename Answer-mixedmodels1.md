...
because the random intercept model calculates the difference in means
between time 3 and time 1, whereas the paired t-test takes this
diffrence between time 1 and time 3)
