---
title: "Answers to exercises Linear models"
output:
  html_document:
    toc: true
    toc_depth: 1
...
The nulhypothesis that the regression coefficient in the
...
interaction from model.i and model.ii. So the interaction term in these models shows wether the difference inslopes is the same in both groups.
